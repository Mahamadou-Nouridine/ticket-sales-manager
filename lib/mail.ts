...
export async function sendDemandNotification(
    emails: string[],
    data: {
        sellerName: string;
    ...
    const mailOptions = {
        from: process.env.MAIL_SENDER,
        to: emails.join(", "),
        subject: `[Nouvelle Demande] Demande de tickets - ${data.tenantName}`,
        html: `
            <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 0; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; color: #1e293b;">
                <div style="background-color: #f59e0b; padding: 30px 20px; text-align: center;">
                    <h1 style="color: white; margin: 0; font-size: 24px; font-weight: 700;">Nouvelle Demande de Tickets</h1>
                </div>
                <div style="padding: 30px; line-height: 1.6;">
                    <p style="font-size: 16px; margin-bottom: 20px;">Bonjour,</p>
                    <p style="font-size: 16px; margin-bottom: 24px;">Une nouvelle demande de tickets a été soumise et nécessite votre approbation.</p>
                    ...
                    <div style="background-color: #f8fafc; padding: 24px; border-radius: 8px; border: 1px solid #cbd5e1; margin-bottom: 30px;">
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="padding: 8px 0; color: #64748b; font-size: 14px;">Type de Ticket:</td>
                                <td style="padding: 8px 0; color: #0f172a; font-weight: 600; text-align: right;">${data.ticketTypeName}</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px 0; color: #64748b; font-size: 14px;">Quantité:</td>
                                <td style="padding: 8px 0; color: #f59e0b; font-weight: 700; text-align: right; font-size: 18px;">${data.quantity}</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px 0; color: #64748b; font-size: 14px;">Organisation:</td>
                                <td style="padding: 8px 0; color: #0f172a; text-align: right;">${data.tenantName}</td>
                    ...
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="${data.dashboardUrl}" style="background-color: #f59e0b; color: white; padding: 12px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; display: inline-block;">Voir et Gérer les Demandes</a>
                    </div>
